...
## Documentazione per contributor e agenti
...
mentre `Docs/ai` resta responsabile di architettura, convenzioni e operazioni. La directory
`openspec/` presente nel repository e l'unica root di specifica e deve restare versionata insieme
al codice che descrive.
